...
final TextStyle Heading_06 = TextStyle(fontFamily: 'NotoSansKR', fontWeight: FontWeight.w500, fontSize: 24.sp);
final TextStyle Heading_07 = TextStyle(fontFamily: 'NotoSansKR', fontWeight: FontWeight.w900, fontSize: 22.sp);

final TextStyle m_Heading_01 = TextStyle(fontFamily: 'NotoSansKR', fontWeight: FontWeight.w700, fontSize: 22.sp);
final TextStyle m_Heading_02 = TextStyle(fontFamily: 'IBMPlexSansKR', fontWeight: FontWeight.w700, fontSize: 20.sp);
final TextStyle m_Heading_03 = TextStyle(fontFamily: 'IBMPlexSansKR', fontWeight: FontWeight.w600, fontSize: 18.sp);
...
final TextStyle Button_03 = TextStyle(fontFamily: 'IBMPlexSansKR', fontWeight: FontWeight.w500, fontSize: 20.sp);

final TextStyle m_Button_00 = TextStyle(fontFamily: 'IBMPlexSansKR', fontWeight: FontWeight.w700, fontSize: 14.sp); // -4
final TextStyle m_Button_01 = TextStyle(fontFamily: 'IBMPlexSansKR', fontWeight: FontWeight.w600, fontSize: 16.sp);
final TextStyle m_Button_02 = TextStyle(fontFamily: 'IBMPlexSansKR', fontWeight: FontWeight.w600, fontSize: 13.sp);
